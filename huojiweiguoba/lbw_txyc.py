...
class JdGoods(BaseModel):
    ...
    goods_notes = peewee.CharField(null=False, verbose_name='备注')
    goods_images_local_path = peewee.TextField(null=False, verbose_name='图片本地路径')
...
class JdListing(BaseModel):
    ...
    create_date_time = peewee.DateTimeField(null=False,verbose_name='创建时间')
